<?PHP // $Id$ 
      // quiz.php - created with Moodle 1.8.4+ (2007021541)
...
$string['formatoptions'] = 'Настройки этого формата импорта';
...
$string['giftwithimg'] = 'Формат GIFT с картинками';
$string['grade'] = 'Оценка';
...
$string['keptcategory1'] = 'значением из того же открытого набора, что и прежде';
$string['keptcategory2'] = 'файлом из того же открытого набора, что и прежде';
$string['keptcategory3'] = 'ссылкой из того же открытого набора, что и прежде';
$string['keptlocal1'] = 'значением из того же закрытого набора, что и прежде';
$string['keptlocal2'] = 'файлом из того же закрытого набора, что и прежде';
$string['keptlocal3'] = 'ссылкой из того же закрытого набора, что и прежде';
...
$string['newcategory1'] = 'значением из нового набора, которая также может использоваться другими вопросами данной категории';
$string['newcategory2'] = 'файлом из нового набора, который также может использоваться другими вопросами данной категории';
$string['newcategory3'] = 'ссылкой из нового набора, которая также может использоваться другими вопросами данной категории';
$string['newlocal1'] = 'значением из нового набора, которая может использоваться только данным вопросом';
$string['newlocal2'] = 'файлом из нового набора, который может использоваться только данным вопросом';
$string['newlocal3'] = 'ссылкой из нового набора, которая может использоваться только данным вопросом';
...
$string['noformatoptions'] = 'Нет дополнительных настроек для данного формата';
...
$string['popupnotice'] = 'Ученики увидят этот тест в \"защищенном\" окне';
...
$string['reviewoptions'] = 'Ученики могут просматривать';
